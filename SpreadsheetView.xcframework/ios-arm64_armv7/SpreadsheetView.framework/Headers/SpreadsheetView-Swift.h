...
SWIFT_CLASS("_TtC15SpreadsheetView11Spreadsheet")
@interface Spreadsheet : UIView
...
@interface Spreadsheet (SWIFT_EXTENSION(SpreadsheetView))
...
@interface Spreadsheet (SWIFT_EXTENSION(SpreadsheetView)) <UIScrollViewDelegate>
